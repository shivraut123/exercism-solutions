...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    power_generated =temperature * neutrons_produced_per_second 
    if power_generated < 0.9 * threshold:
        return "LOW"
    elif power_generated >= 0.9 * threshold and power_generated <= 1.1 * threshold:
        return "NORMAL"
    else:
        return "DANGER"
