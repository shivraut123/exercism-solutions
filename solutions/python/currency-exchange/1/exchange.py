...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_money = budget / actual_rate
    total_denomination = exchange_money // denomination
    total_exchanged_amount = total_denomination * denomination
    return total_exchanged_amount
